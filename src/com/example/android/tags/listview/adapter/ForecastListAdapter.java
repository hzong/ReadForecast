...
public class ForecastListAdapter extends ArrayAdapter<Forecast> {
	...
	class ViewHolder {
		 ...
		 * @fieldType TextView[]
		 */
		private TextView[] week = { (TextView) view.findViewById(R.id.week_one),
				(TextView) view.findViewById(R.id.week_two),
				(TextView) view.findViewById(R.id.week_three),
				(TextView) view.findViewById(R.id.week_four),
				(TextView) view.findViewById(R.id.week_five),
				(TextView) view.findViewById(R.id.week_six),
				(TextView) view.findViewById(R.id.week_sun) };
		/**
		 * @fieldName is_use
		 * @describe 是否使用
		 * @fieldType ImageView
		...
		public void setWeek(int[] week) {
			if(week == null)
				return;
			for (int val : week) {
				this.week[val].setTextColor(Color.parseColor("#8c9eff"));
			}
		}
